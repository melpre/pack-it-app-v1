            ...
            <Col key={item} >
                <div className="input-group mb-1">
                    <div className="input-group-text">
                        ...
                        />
                        <input type="number" className="form-control mx-1" aria-label="quantity input" placeholder={state.daysOfTravel}></input>
    ...
    return (
        <div>
            ...
            <Container className="container-fluid border">
                <h2 className="text-left my-3">{current}</h2>
                <div>
                    <p>
                ...
                <ButtonGroup aria-label="Basic example" className="my-3">
                    ...
                    <Button id="carryon" variant="primary" onClick={handleClick}>Carry On</Button>
